...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-celebrate-moment.js
  var import_celebrate_moment_exports = {};
  __export(import_celebrate_moment_exports, {
    default: () => import_celebrate_moment_default
  });
  ...
  var import_celebrate_moment_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_celebrate_moment_exports);
})();
